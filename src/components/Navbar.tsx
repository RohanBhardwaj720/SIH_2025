...
import { Sun, Moon, LogOut, UserCircle, User } from "lucide-react";
      ...
      <div className="container mx-auto flex items-center justify-between px-3">
        <div className="text-xl font-bold tracking-tight">
          <Link href="/" className="flex items-center gap-2"> 
            <span className="hidden sm:inline dark:text-white">FarmSense</span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          {session && (
            ...
            <PopoverContent className="w-56 p-2 bg-black" align="end">
              ...
              <div className="grid gap-1">
                <Link
                  href="/profile"
                  className="flex w-full items-center gap-2 rounded px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                >
